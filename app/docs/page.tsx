...
export default function DocsPage() {
  return <main className="seo-shell docs-shell">
    ...
    <footer className="seo-footer"><span>Documentation · Release 0.10.0</span><Link href="/learn">Read plain-language guides</Link><Link href="/security">Review security & known limitations →</Link><a href="https://x.com/hoodfloow" target="_blank" rel="noreferrer">𝕏 @hoodfloow</a></footer>
  </main>;
}
