...
export default function SecurityPage() {
  return <main className="seo-shell">
    <header className="seo-nav"><Link href="/" className="seo-logo">hoodflow<span>MAINNET BETA</span></Link><nav><Link href="/stock-tokens">Markets</Link><Link href="/how-it-works">How it works</Link><Link href="/?view=assets" className="seo-cta">Open app</Link></nav></header>
    ...
    <footer className="seo-footer"><Link href="/how-it-works">Read the execution flow</Link><Link href="/stock-tokens">Explore verified markets →</Link></footer>
  </main>;
}
