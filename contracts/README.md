...
- Eighteen direct Buy/Sell routes are enabled after full-input fork verification. Sixteen use the reviewed V4 adapter path; SLV and CUSO use reviewed V3 routes.
- Recurring execution remains deliberately narrower at thirteen reviewed V4 assets.
